...
const WeekDayCard = ({ data, weatherUnits }) => {
  ...
  return (
    <div className="font-dongle text-center p-6 rounded-md bg-white/30 shadow-md flex justify-center items-center md:flex-col">
      <p className="text-3xl font-[700] md:mb-1 tracking-wide">{data.day}</p>
      <p className="text-4xl  ml-6 md:mb-4 md:ml-0">
        {averageTemperature}{" "}
        <span className="">
